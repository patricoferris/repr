...
module type S4 = sig
  ...
  val encode : 'a encoder -> 'b encoder -> 'c encoder -> 'd encoder -> ('a, 'b, 'c, 'd) t encoder
  val decode : 'a decoder -> 'b decoder -> 'c decoder -> 'd decoder -> ('a, 'b, 'c, 'd) t decoder
  val sizer : 'a sizer -> 'b sizer -> 'c sizer -> 'd sizer -> ('a, 'b, 'c, 'd) t sizer
end
